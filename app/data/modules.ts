...
export const MODULES: Module[] = [
  ...
  },
  {
    ...
    icon: '📖',
    color: '#0E6655',
    description: '50 mots de vocabulaire classique avec exemples et contexte',
  ...
  },
  {
    ...
    icon: '⚙️',
    color: '#6C3483',
    description: '10 verbes courants avec leur racine trilittère et leurs formes',
  ...
  },
  {
    ...
    icon: '💬',
    color: '#B7411A',
    description: '10 expressions courantes en arabe classique avec analyse grammaticale',
